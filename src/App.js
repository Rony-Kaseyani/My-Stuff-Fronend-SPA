    ...
    if (this.state.loginFormOpen) {
      ...
      content = (
        <DataTable
          ...
          onProductSelect={this.displayProduct}
        />
      );
    }
    return (
        ...
        <div id="header">
          ...
          <div id="menubar">
            <ul id="menu">
              <li
                className={
                  this.state.selectedCategory == "Home" ? "selected" : ""
                }
              >
                <a
                  onClick={() => {
